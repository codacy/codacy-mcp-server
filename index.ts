...
// Tool definitions
const tools: { [key in toolKeys]: Tool } = {
  codacy_list_repositories: {
...
const toolHandlers: { [key in toolKeys]: (args: any) => Promise<any> } = {
  codacy_list_repositories: listOrganizationRepositoriesHandler,
  codacy_list_srm_items: searchSecurityItemsHandler,
  codacy_list_repository_issues: searchRepositoryIssuesHandler,
  codacy_list_repository_pull_requests: listRepositoryPullRequestsHandler,
  codacy_list_files: listFilesHandler,
  codacy_get_file_issues: getFileIssuesHandler,
  codacy_get_file_coverage: getFileCoverageHandler,
  codacy_get_repository_pull_request_files_coverage: getRepositoryPullRequestFilesCoverageHandler,
  codacy_get_pull_request_git_diff: getPullRequestGitDiffHandler,
  codacy_list_pull_request_issues: listPullRequestIssuesHandler,
};
...
server.setRequestHandler(CallToolRequestSchema, async request => {
  try {
    ...
    const handler = toolHandlers[request.params.name as ToolHandlerKey];
